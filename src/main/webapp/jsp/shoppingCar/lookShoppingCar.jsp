     ...
     <center><br><br>
        ...
        <%   
             LinkedList<String> items = null;
              ...
              {%>
                    ...
                    <a href="/hjy1/hjy.dao/GoodsDao?key=4"><font color=red size=6>购物</font></a> 
              <%
                return;
              }
        %>
       <table border="1" bordercolor="#4EEE94" cellpadding="10" cellspacing="0" width="400" height="80">
        ...
        double totalPrice = 0.00;
            ...
            %> <td><a href='/hjy1/hjy.goods/DeleteGoodsFromCar?ID=<%= j %>' >删除</a></td></tr><%
              }
              String backPage = "<a href='/hjy/jsp/browse/showGoods.jsp'><font color=green><b>继续购物</b></font></a>";
           %>
       </table>
       ...
       <table cellpadding="10" cellspacing="0" width="400" height="80">
           <tr>
              ...
              <td>
                    <form action="/hjy1/hjy.goods/BuyGoods" method="post">
